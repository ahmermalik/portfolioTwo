...
<cite className="f6 ttu tracked secondary-text fs-normal">Ashar Malik, <br /> <br /> Lead developer at Microsoft</cite>
</div>
</div>
<div className='w-100 dib ph2 mt5'>
<p className="f5 f4-m lh-copy db">Ahmer is the kind of designer that is not afraid to get his hands dirty and code up his designs in html, css and even javascript, making the job of the developer(s) much easier and workflow seamless and efficient. He is not afraid of learning new technologies (like tachyons or react) quickly and he is always using the best tools on the market and constantly researching new ones. His approach is simple, yet elegant. Asset to any team.</p>
<cite className="f6 ttu tracked secondary-text fs-normal">Juan Pablo <br /> <br /> Lead developer at Google</cite>
</div>
</div>
</section>
    )
