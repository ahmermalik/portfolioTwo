...
class Work extends React.Component {
  render() {
    ...
    <section id='Portfolio'>
        ...
        <WorkTileOut title='Chatroom App' info=' Socket.IO, JavaScript, Express, Node.js, HTML5, CSS3, Handlebars.js, Bootstrap' summary='A socket io web app with designated chatrooms.' img='/images/preview/comingsoon.png' link='https://github.com/ahmermalik/chatroomApp'/>

        <WorkTileOut title='Weather App' info='Python, PostgreSQL, HTML5, CSS3, Handlebars.js, Bootstrap' summary='Web application utilize weather api to render data for various cities.' img='/images/preview/weathapp-min.png' link='https://github.com/ahmermalik/weatherApp'/>
        <WorkTileOut title='Gas Price App' info='Basic JavaScript, HTML5, CSS3,jQuery' summary='Single page static web app to calculate cost variances which produces automated recommendation of payment channel.' img='/images/preview/gasprice-min.png' link='https://github.com/ahmermalik/ahmermalik.github.io'/>
