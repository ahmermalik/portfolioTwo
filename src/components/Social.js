...
class Social extends React.Component {
  render() {
    return (
<div className="mt4">
        <a className="link dim gray dib br-100 h2 w2 mr3 pa1" target='blank' href="https://github.com/ahmermalik" title='Github'>
        ...
        <a className="link dim gray dib br-100 h2 w2 mr3 pa1" target='blank' href="https://www.linkedin.com/in/ahmer-malik/" title='LinkedIn'>
